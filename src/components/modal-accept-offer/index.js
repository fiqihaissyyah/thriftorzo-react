	...
	return (
		<>
			<Modal closeIcon={<X size={24} />} bodyStyle={{ padding: '56px 32px 24px' }} width={360} footer={null} visible={isModalVisible} onCancel={handleCancel}>
				...
				<p className='text-sm text-[#8A8A8A] mb-4'>Segera hubungi pembeli melalui whatsapp untuk transaksi selanjutnya</p>
				<div className='product-match p-4 md:bg-[#EEEEEE] md:shadow-none shadow-custom bg-white rounded-2xl mb-6'>
					...
					<div className='buyer flex mb-4'>
						...
						<div className='buyer-info w-full flex flex-col justify-center'>
							<p className='text-sm text-black font-medium mb-1'>Nama Pembeli</p>
					...
					<div className='product flex'>
						...
						<div className='product-info w-full flex flex-col justify-center'>
							<p className='text-sm text-black mb-1'>Jam Tangan Casio</p>
							<p className='text-sm text-black mb-1'>Rp 250.000</p>
							<p className='text-sm text-black mb-0'>Ditawar Rp 200.000</p>
						</div>
					</div>
				</div>
				<Button type='primary' className='btn-custom w-full'>Hubungi via Whatsapp <WhatsAppOutlined /></Button>
			</Modal>
		</>
	);
}
