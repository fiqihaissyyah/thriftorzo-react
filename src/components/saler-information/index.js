	...
	return (
		<div className='saler-information p-4 shadow-custom rounded-2xl flex justify-between items-center'>
			<div className='saler-profile flex items-center'>
				<Avatar size={48} className='rounded-xl' src="https://joeschmoe.io/api/v1/random" />
				<div className='ml-4'>
					<p className='text-sm text-black mb-1'>Nama Penjual</p>
					<span className='text-[10px] text-[#8A8A8A] block leading-[14px]'>Kota</span>
				</div>
			</div>
			<Button onClick={handleProfile} className='text-xs py-1 px-3 rounded-lg' type='primary' ghost>Edit</Button>
		</div>
	);
}
